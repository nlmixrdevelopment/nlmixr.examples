expected_values[[runno]] <- list(lik = c(-43477.48, 86968.97, 87016.89), param = c(6.9067, 
...
"eta.VM", "eta.KM"))), time = structure(list(saem = 188.351, 
    setup = 0.211415999999851, table = 0.521999999999935, cwres = 0.749000000000024, 
    covariance = 0.669999999999845, other = 0.853584000000211), class = "data.frame", row.names = "elapsed"), 
    objDf = structure(list(OBJF = 74181.721739806, AIC = 86968.967351351, 
        BIC = 87016.8928299209, "Log-likelihood" = -43477.4836756755, 
