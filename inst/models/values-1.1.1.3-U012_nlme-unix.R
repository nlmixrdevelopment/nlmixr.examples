expected_values[[runno]] <- list(lik = c(-12780.75, 25571.49, 25600.14), param = c(1.3876, 
...
), c("eta.Vc", "eta.Cl"))), time = structure(list(nlme = 249.837, 
    setup = 0.191196000001106, table = 0.0740000000005239, cwres = 0.275000000001455, 
    other = 0.144803999994593), class = "data.frame", row.names = "elapsed"), 
    objDf = structure(list(OBJF = c(21378.4839634803, 21378.648427807
    ), AIC = c(25571.4921666279, 25571.6566309547), BIC = c(25600.1430406042, 
    25600.3075049309), "Log-likelihood" = c(-12780.746083314, 
