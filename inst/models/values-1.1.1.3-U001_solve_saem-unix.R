...
4.2046, 0.19785), stdev_param = c(0.30235, 0.27063, NA), sigma = c(prop.err = 0.19785), 
    ...
    ), c("eta.Vc", "eta.Cl"))), time = structure(list(saem = 20.455, 
        setup = 6.84153899999999, table = 0.0570000000000022, 
        cwres = 6.909, covariance = 0.0450000000000017, other = 0.284461), class = "data.frame", row.names = "elapsed"), 
