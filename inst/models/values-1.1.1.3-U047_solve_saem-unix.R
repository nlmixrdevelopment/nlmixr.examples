...
0.22143, 0.28636, NA), sigma = c(prop.err = 0.48588), parFixedDf = structure(list(
    ...
    ), SE = c(lCl = 0.021340840911761, lVc = 0.0935233622459422, 
    lQ = 1.79170355956471, lVp = 0.715445121080358, prop.err = NA
    ), "%RSE" = c(1.76779087273862, 1.9754037989268, 63.4216096375622, 
    ...
    564.952911733859, 59.4805929144088, NA), "BSV(CV%)" = c(22.0949734107065, 
...
0, 0, 0, 0, 0.0820012005606898), .Dim = c(4L, 4L), .Dimnames = list(
    ...
    "eta.Vp", "eta.Q"))), time = structure(list(saem = 93.285, 
    setup = 0.190949999999979, table = 0.309000000000026, cwres = 0.560000000000002, 
    covariance = 0.326999999999998, other = 0.553049999999942), class = "data.frame", row.names = "elapsed"), 
