...
0, 0, 0, 0, 0.157239748979002), .Dim = c(4L, 4L), .Dimnames = list(
    ...
    "eta.Vp", "eta.Q"))), time = structure(list(saem = 78.4809999999998, 
    setup = 0.191328999999287, table = 0.0650000000005093, covariance = 0.0249999999996362, 
    other = 1.05667100000213, logLik = 0.496000000001004), class = "data.frame", row.names = "elapsed"), 
