...
0.3175, 0.29593, 0.39366, 0.32311, NA), sigma = c(prop.err = 0.19879), 
    ...
    lKA = -0.074555387110245, prop.err = 0.198792726410034), 
        SE = c(lCl = 0.0291389459164311, lVc = 0.027764290590483, 
        ...
        64.1153854661381, 3.70968186492727, 44.8426142341409, 
    ...
    "eta.Q", "eta.KA"))), time = structure(list(saem = 458.343, 
        setup = 0.168442999999556, table = 0.643000000000029, 
        cwres = 0.88799999999992, covariance = 0.251000000000204, 
        other = 0.458556999999928), class = "data.frame", row.names = "elapsed"), 
    objDf = structure(list(OBJF = 64220.9162349487, AIC = 77034.5406171578, 
        BIC = 77109.8678994444, "Log-likelihood" = -38506.2703085789, 
        "Condition Number" = 6.43339359715969), row.names = "FOCEi", class = "data.frame")) 
