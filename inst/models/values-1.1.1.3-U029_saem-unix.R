expected_values[[runno]] <- list(lik = c(-12032.36, 24082.73, 24134.31), param = c(6.9114, 
...
0, 0, 0, 0, 0.0944403870778222), .Dim = c(4L, 4L), .Dimnames = list(
    ...
    "eta.KM", "eta.KA"))), time = structure(list(saem = 135.468, 
    setup = 8.78646100000025, table = 0.115999999999985, cwres = 8.92200000000048, 
    covariance = 0.510000000000218, other = 0.922538999998665), class = "data.frame", row.names = "elapsed"), 
    objDf = structure(list(OBJF = 19876.2054079756, AIC = 24082.7272423225, 
        BIC = 24134.3106705857, "Log-likelihood" = -12032.3636211613, 
