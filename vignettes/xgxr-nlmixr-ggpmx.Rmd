...
vignette: >
  %\VignetteIndexEntry{xgxr nlmixr and ggPmx integration}
...
plot(augPred(cmt2fit.logn))

addNpde(cmt2fit.logn)
...
## ## Unlike standard tidyverse, the controller is modified by piping plots into it.
